...
n_steps = 20;
action.u = [zeros(1,n_steps);ones(1,n_steps)]*5;
...
%     [res] = vrep.simxTransferFile(clientID,'/home/ajinkya/Dropbox/FIRM_toolbox_ver_current/cube1.obj','cube1.obj',20,vrep.simx_opmode_oneshot_wait);
    ...
    [response] = vrep.simxLoadScene(clientID,'/home/ajinkya/Dropbox/summer13/V-REP_PRO_EDU_V3_0_3_Linux/scenes/myscenes/myscene2.ttt',0,vrep.simx_opmode_oneshot_wait);
    pause(1);
...
%         
    ...
    for i= 1:1:(length(action.u))
        ...
        % giving motor velocity
            [res] = vrep.simxSetJointTargetVelocity(clientID,left_joint, ((action.u(1,i)+((action.u(2,i)*0.254)/2)))*2/0.085, vrep.simx_opmode_streaming);
            [res] = vrep.simxSetJointTargetVelocity(clientID,right_joint, ((action.u(1,i)-((action.u(2,i)*0.254)/2)))*2/0.085, vrep.simx_opmode_streaming);
        pause(0.5);
