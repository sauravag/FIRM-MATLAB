...
classdef vrep_interface_youbot %< SimulatorInterface
    properties
        %connection Property
        vrep;
        clientID;
    ...
    methods
        %% Constructor
        function obj = vrep_interface_youbot()
    ...
    methods
        ...
        function obj = simInitialize(obj)
            ...
            %                 end
            %             end
            obj.scene = 'C:\Users\Ajinkya\Documents\youbot1.ttt';
