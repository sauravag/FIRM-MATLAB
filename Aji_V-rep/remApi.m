...
classdef remApi
    ...
    methods
        ...
        function [rtn ]= simxSetJointForce(obj,clientID,objectHandle,targetVelocity,operationMode)
            objectHandle_ = int32(objectHandle);
            targetVelocity_ = single(targetget);
            operationMode_ = int32(operationMode);
        ...
        function [rtn linearVelocity angularVelocity] = simxGetObjectVelocity(obj,clientID,handle,operationMode)
            ...
            [rtn linearVelocity angularVelocity] = calllib(obj.libName,'simxGetObjectVelocity',clientID,handle_,linearVelocity, angularVelocity,operationMode_);
        end
