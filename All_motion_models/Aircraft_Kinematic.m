...
%         end
        function J = df_du_func(x,u,w)
            ...
            b_11 = 0;
            b_12 = 0.5 *(-q1*R_gb(1,1) - q2*R_gb(2,1) + q3*R_gb(3,1))* Aircraft_Kinematic.dt ;
            b_13 = 0.5 *(-q1*R_gb(1,2) - q2*R_gb(2,2) + q3*R_gb(3,2))* Aircraft_Kinematic.dt ;
            b_14 = 0.5 *(-q1*R_gb(1,3) - q2*R_gb(2,3) + q3*R_gb(3,3))* Aircraft_Kinematic.dt ;
            b_21 = 0 ;
            b_22 = 0.5 *(q0*R_gb(1,1) - q3*R_gb(2,1) + q2*R_gb(3,1))* Aircraft_Kinematic.dt ;
            b_23 = 0.5 *(q0*R_gb(1,2) - q3*R_gb(2,2) + q2*R_gb(3,2))* Aircraft_Kinematic.dt ;
            b_24 = 0.5 *(q0*R_gb(1,3) - q3*R_gb(2,3) + q2*R_gb(3,3))* Aircraft_Kinematic.dt ;
            b_31 = 0 ;
            b_32 = 0.5 *(q3*R_gb(1,1) + q0*R_gb(2,1) - q1*R_gb(3,1))* Aircraft_Kinematic.dt ;
            b_33 = 0.5 *(q3*R_gb(1,2) + q0*R_gb(2,2) - q1*R_gb(3,2))* Aircraft_Kinematic.dt ;
            b_34 = 0.5 *(q3*R_gb(1,3) + q0*R_gb(2,3) - q1*R_gb(3,3))* Aircraft_Kinematic.dt ;
            b_41 = 0;
            b_42 = 0.5 *(-q2*R_gb(1,1) + q1*R_gb(2,1) + q0*R_gb(3,1))* Aircraft_Kinematic.dt ;
            b_43 = 0.5 *(-q2*R_gb(1,2) + q1*R_gb(2,2) + q0*R_gb(3,2))* Aircraft_Kinematic.dt ;
            b_44 = 0.5 *(-q2*R_gb(1,3) + q1*R_gb(2,3) + q0*R_gb(3,3))* Aircraft_Kinematic.dt ;
        ...
        function J = df_dw_func(x,u,w) % noise Jacobian
            ...
            g_11 = 0;
            g_12 = 0.5 *(-q1*R_gb(1,1) - q2*R_gb(2,1) + q3*R_gb(3,1))* sqrt(Aircraft_Kinematic.dt) ;
            g_13 = 0.5 *(-q1*R_gb(1,2) - q2*R_gb(2,2) + q3*R_gb(3,2))* sqrt(Aircraft_Kinematic.dt) ;
            g_14 = 0.5 *(-q1*R_gb(1,3) - q2*R_gb(2,3) + q3*R_gb(3,3))* sqrt(Aircraft_Kinematic.dt) ;
            g_21 = 0 ;
            g_22 = 0.5 *(q0*R_gb(1,1) - q3*R_gb(2,1) + q2*R_gb(3,1))* sqrt(Aircraft_Kinematic.dt);
            g_23 = 0.5 *(q0*R_gb(1,2) - q3*R_gb(2,2) + q2*R_gb(3,2))* sqrt(Aircraft_Kinematic.dt);
            g_24 = 0.5 *(q0*R_gb(1,3) - q3*R_gb(2,3) + q2*R_gb(3,3))* sqrt(Aircraft_Kinematic.dt) ;
            g_31 = 0 ;
            g_32 = 0.5 *(q3*R_gb(1,1) + q0*R_gb(2,1) - q1*R_gb(3,1))* sqrt(Aircraft_Kinematic.dt) ;
            g_33 = 0.5 *(q3*R_gb(1,2) + q0*R_gb(2,2) - q1*R_gb(3,2))* sqrt(Aircraft_Kinematic.dt) ;
            g_34 = 0.5 *(q3*R_gb(1,3) + q0*R_gb(2,3) - q1*R_gb(3,3))* sqrt(Aircraft_Kinematic.dt) ;
            g_41 = 0;
            g_42 = 0.5 *(-q2*R_gb(1,1) + q1*R_gb(2,1) + q0*R_gb(3,1))* sqrt(Aircraft_Kinematic.dt) ;
            g_43 = 0.5 *(-q2*R_gb(1,2) + q1*R_gb(2,2) + q0*R_gb(3,2))* sqrt(Aircraft_Kinematic.dt) ;
            g_44 = 0.5 *(-q2*R_gb(1,3) + q1*R_gb(2,3) + q0*R_gb(3,3))* sqrt(Aircraft_Kinematic.dt) ;
