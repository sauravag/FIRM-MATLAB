classdef stabilizer_class < Stabilizer_interface
    ...
    methods
        function obj = stabilizer_class(PRM_nodes_on_orbit_inp,  PRM_orbit_inp, target_node_indices)  % Two first inputs are only for consistency with the other FIRM_node_classes. This issue should be resolved.
            if nargin > 0
