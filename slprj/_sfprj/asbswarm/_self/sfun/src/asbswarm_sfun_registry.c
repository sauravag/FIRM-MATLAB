...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_asbswarm_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_asbswarm_lib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_asbswarm_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_asbswarm_lib_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_asbswarm_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_asbswarm_lib_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "asbswarm") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_asbswarm_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "asbswarm_lib") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_asbswarm_lib_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_asbswarm_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_asbswarm_lib_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "asbswarm") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_asbswarm_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "asbswarm_lib") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_asbswarm_lib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_asbswarm_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_asbswarm_lib_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"asbswarm")) {
    return(sf_asbswarm_method_dispatcher(simstructPtr,chartFileNumber,specsCksum,
            method,data));
  }

  if (!strcmp(machineName,"asbswarm_lib")) {
    return(sf_asbswarm_lib_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void asbswarm_terminator(void);
extern void asbswarm_lib_terminator(void);
...
extern void asbswarm_initializer(void);
extern void asbswarm_lib_initializer(void);
extern void asbswarm_register_exported_symbols(SimStruct* S);
extern void asbswarm_lib_register_exported_symbols(SimStruct* S);
extern void asbswarm_debug_initialize(void);
extern void asbswarm_lib_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  asbswarm_register_exported_symbols(S);
  asbswarm_lib_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      asbswarm_debug_initialize();
    }

    asbswarm_initializer();
    if (!simModeIsRTWGen) {
      asbswarm_lib_debug_initialize();
    }

    asbswarm_lib_initializer();
  }
